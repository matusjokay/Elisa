# Generated by Django 2.1 on 2019-05-02 01:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('NEW', 'New'), ('WIP', 'Work in progress'), ('RFM', 'Ready for merge'), ('PFT', 'Published for teachers'), ('PPV', 'Publish public version')], default='NEW', max_length=3)),
        ...
        migrations.AddField(
            ...
            name='events',
            field=models.ManyToManyField(to='timetables.Event'),
        ),
    ]
